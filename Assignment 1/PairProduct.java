/*
* CSC 225 Assignment 1 PairProduct225 
* Jordan (Yu-Lin) Wang 
* V00786970
*/
...
public class PairProduct{
	...
	*/
	public static boolean PairProduct225(int[] A){
		...
		//creating a new array to store the elements that do not exceed 225
		int[] w = new int[226];
		int c = 0;
		...
		//finding if there is a pair of elements which multiply to 225
		for (int j = 1; j < w.length; j++){
			if (w[j] > 0 && (225 % j == 0) && w[225/j] > 0 && c!=1){
				return true;
			}
		}
